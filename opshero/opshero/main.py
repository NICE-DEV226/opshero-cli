...
from opshero.commands.team import team_group
...
SECTIONS = [
    ...
    (
        ...
        [
            "team",
            "team projects",
            r"team switch <project>",
            "team analyses",
            r"team project [id]",
            "team clear",
        ],
        [
            "Team overview + active project context",
            "List all team projects with stats",
            "Set active project (persists between sessions)",
            "Team-wide analysis feed across all projects",
            "Project details + recent analyses",
